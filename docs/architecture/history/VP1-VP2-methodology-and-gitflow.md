# Architecture History - VP1/VP2 (TH1, TH2)

> Preserves the former `docs/architecture/README.md` content, with only this
> historical preamble, title, and an adjusted relative link. TH1 and TH2 are
> locked; this document is context, not the current target architecture. See
> `docs/architecture/README.md` for the VP3 target.
