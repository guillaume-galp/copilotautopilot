...
|---|---|
| Schema version | 1 |
| Vision | docs/vision_of_product/VP9-fixture/VP9.md |
...
| Scope | VP9 Discovery dossier with bounded deferrals |
| Disposition | FULL |
| Verdict | READY_WITH_DEFERRALS |
| Rationale | Every remaining item has an accepted owner and disposition. |
